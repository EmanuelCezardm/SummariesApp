final List<Map<String, dynamic>> resumoFusosHorarios = [
  ...
  {
    'text':
        'A finalidade dessa divisão é padronizar o cálculo de tempo em todo o planeta Terra.',
    'id_type': 2,
  },
  {
    'text':
  ...
  {
    'text':
        'Os fusos horários corrigiram isso ao instituir um tempo solar médio. Entretanto, esse processo de padronização teve início somente a partir de 1878, quando Sanford Fleming, a partir de seus estudos de astronomia, propôs a divisão mundo em 24 faixas verticais.',
    'id_type': 2,
  },
  {
    'text':
