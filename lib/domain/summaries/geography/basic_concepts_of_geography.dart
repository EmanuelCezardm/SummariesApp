final List<Map<String, dynamic>> resumoConceitosGeo = [
  ...
  {
    'text':
        'A Geografia moderna tem como precursor Humboldt, que baseava-se no empirismo; posteriormente surgiram diversos outros pensadores que agregaram conhecimentos e conceitos distintos que serviram para o enriquecimento da ciência.',
    'id_type': 2,
  },
  {
    'text': 'Algumas especialidades da ciência Geográfica:',
    'id_type': 1,
  },
  {
    'text':
