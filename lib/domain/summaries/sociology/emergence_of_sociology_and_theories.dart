final List<Map> resumoSurgimentoDaSociologia = [
  ...
  {
    'text':
        'Para Durkheim, as idéias de Comte eram muito mais próximas de uma abstração filosófica do que do rigor de uma ciência, o que impossibilitava o crescimento científico da Sociologia. Mediante um método comparativo que visava a buscar os fatos sociais que marcavam as diferentes sociedades e compará-los.',
    'id_type': 2,
  },
  {
    'text':
        'A fim de entender os diferentes funcionamentos sociais e compreender os diferentes modos de coesão social, Durkheim fundamentou a Sociologia como um estudo autônomo e rigoroso.',
    'id_type': 2,
  },
  {
    'text':
